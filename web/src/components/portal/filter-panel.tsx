  ...
  return (
    <label className="grid min-w-0 gap-1.5 text-sm font-semibold text-[#47413f]" htmlFor={id}>
      ...
      <select
        ...
        name={name}
        defaultValue={value ?? ""}
        className="h-10 w-full min-w-0 rounded-xl border border-[#cad1dd] bg-white px-3 text-sm text-(--color-text) outline-none transition focus-visible:ring-2 focus-visible:ring-(--color-accent-blue)"
      >
